      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-cream-muted text-lg leading-relaxed font-light">
              <p>
            ...
            {timeline.map((item, idx) => (
              <div key={idx} className="group flex gap-6 items-start">
                <div className="flex flex-col items-center mt-2">
                  <div className="w-3 h-3 rounded-full bg-gold/60 group-hover:bg-gold transition-colors border-2 border-dark" />
                  {idx < timeline.length - 1 && <div className="w-px h-full bg-gold/10 min-h-[60px]" />}
                </div>
                <div className="pb-8">
