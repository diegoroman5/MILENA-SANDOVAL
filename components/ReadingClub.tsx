  ...
  return (
    <section id="club" className="py-16 md:py-32 relative overflow-hidden">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        {/* Video Sections: 1. Participación en Eventos → 2. Entrevistas a Autores */}
        <div className="space-y-12 md:space-y-24">
          <div>
            <div className="flex items-center justify-between mb-5 md:mb-8">
              <h3 className="font-serif text-xl sm:text-2xl md:text-3xl font-semibold">Participación en <em className="text-gold italic not-italic">Eventos</em></h3>
            ...
            <div className="flex overflow-x-auto gap-3 md:gap-6 pb-4 md:pb-8 no-scrollbar scroll-smooth -mx-5 px-5 sm:mx-0 sm:px-0">
              {guests.map((v, i) => (
                <VideoCard key={v.id} id={v.id} title={`Evento ${i + 1}`} />
              ))}
            </div>
          </div>
